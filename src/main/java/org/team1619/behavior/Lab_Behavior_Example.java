...
public class Lab_Behavior_Example implements Behavior {

	private static final Logger sLogger = LogManager.getLogger(Lab_Behavior_Example.class);
	...
	public Lab_Behavior_Example(InputValues inputValues, OutputValues outputValues, Config config, RobotConfiguration robotConfiguration) {
